...
const Login = () => {
  ...
  const { login, loading, error, authStep, clearError } = useAuth();
              ...
              <div className="auth-steps">
                <div className="auth-step">
                  <div className={`step-number ${
                    ...
                    ['device', 'credentials', 'success'].includes(authStep) ? 'step-completed' : 'step-inactive'
                  }`}>
                    1
                  </div>
                ...
                <div className="auth-step">
                  <div className={`step-number ${
                    ...
                    ['credentials', 'success'].includes(authStep) ? 'step-completed' : 'step-inactive'
                  }`}>
                    2
                  </div>
                  <div className="step-content">
                ...
                <div className="auth-step">
                  ...
                  <div className="step-content">
                    <div className="step-title">Autenticación de Credenciales</div>
                    <div className="step-description">Verificar usuario y contraseña con Active Directory</div>
                  </div>
                </div>
        ...
        <div className="info-footer" style={{ gridColumn: '1 / -1' }}>
          <div className="info-card">
            <p className="info-text">
              <span className="info-highlight">Seguridad Multi-Factor:</span> Este sistema utiliza verificación de ubicación,
              identificación de dispositivo y autenticación de Active Directory para garantizar
